...
import wjy.weiai7lv.config.WebConstantConfig;
...
public class LovetimeServiceImpl implements LovetimeService {
    ...
    private void pastLovetimeImgUrl(Lovetime lovetime) {
        ...
        if (lovetime.getImg1() != null) {
            lovetime.setImg1(WebConstantConfig.getLovetimeResourceServerName() + lovetime.getImg1());
        }
        if (lovetime.getImg2() != null) {
            lovetime.setImg2(WebConstantConfig.getLovetimeResourceServerName() + lovetime.getImg2());
        }
        if (lovetime.getImg3() != null) {
            lovetime.setImg3(WebConstantConfig.getLovetimeResourceServerName() + lovetime.getImg3());
        }
        if (lovetime.getImgThumb1() != null) {
            lovetime.setImgThumb1(WebConstantConfig.getLovetimeResourceServerName() + lovetime.getImgThumb1());
        }
        if (lovetime.getImgThumb2() != null) {
            lovetime.setImgThumb2(WebConstantConfig.getLovetimeResourceServerName() + lovetime.getImgThumb2());
        }
        if (lovetime.getImgThumb3() != null) {
            lovetime.setImgThumb3(WebConstantConfig.getLovetimeResourceServerName() + lovetime.getImgThumb3());
        }
    }
}
