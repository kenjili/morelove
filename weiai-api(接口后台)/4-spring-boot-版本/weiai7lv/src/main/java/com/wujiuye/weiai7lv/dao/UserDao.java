...
//    int deleteWhiteByTime_v1(@Param("time") Date date,@Param("name")String name);
//
//    int deleteWhiteByTime_v2(@Param("time") Date date);
//
//    //使用java.sql的Date，这样就能解析了
//    int deleteWhiteByTime_v3(@Param("time")java.sql.Date date);
}
