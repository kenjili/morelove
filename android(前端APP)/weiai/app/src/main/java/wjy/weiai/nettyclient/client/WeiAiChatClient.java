package wjy.weiai.nettyclient.client;
...
import wjy.weiai.nettyclient.client.handler.HeartBeatTimerHandler;
import wjy.weiai.nettyclient.client.handler.LoginResponseHandler;
import wjy.weiai.nettyclient.client.handler.MessageResponseHandler;
import wjy.weiai.nettyclient.client.handler.StateResponseHandler;
import wjy.weiai.nettyclient.handler.IMIdleStateHandler;
import wjy.weiai.nettyclient.handler.PacketDecoder;
import wjy.weiai.nettyclient.handler.PacketEncoder;
import wjy.weiai.nettyclient.handler.Spliter;
...
public class WeiAiChatClient {
    ...
    public WeiAiChatClient(Context context, OnConnectServerListener onConnectServerListener) {
