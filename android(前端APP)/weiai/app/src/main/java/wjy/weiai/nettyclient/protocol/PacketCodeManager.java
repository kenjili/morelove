...
import wjy.weiai.nettyclient.protocol.request.HeartBeatRequestPacket;
import wjy.weiai.nettyclient.protocol.request.LoginRequestPacket;
import wjy.weiai.nettyclient.protocol.request.MessageRequestPacket;
import wjy.weiai.nettyclient.protocol.response.HeartBeatResponsePacket;
...
import wjy.weiai.nettyclient.serialize.impl.JSONSerializer;
...
import static wjy.weiai.nettyclient.protocol.command.Command.MESSAGE_REQUEST;
import static wjy.weiai.nettyclient.protocol.command.Command.MESSAGE_RESPONSE;
import static wjy.weiai.nettyclient.protocol.command.Command.REQUEST_STATE;
